...
[![CI](https://img.shields.io/github/stars/catcatcatstudio/cat-skills)](https://github.com/catcatcatstudio/cat-skills/stargazers)
...
| [Cleanse](#cleanse--設定最適化) | `/cleanse` | CLAUDE.mdとエージェント設定のシグナル対ノイズ比を最適化 |
...
| [JP Mode](#jp-mode--日本語トランスクリエーション) | *(自動)* | 日本語トランスクリエーション。翻訳ではなくコピーライティング |
...
CLAUDE.md、メモリファイル、エージェント設定を分析し最適化します。残るすべての行が、モデルの挙動を実際に変えるものでなければなりません。

レポート、ドラフト、適用の2段階承認ゲート付きです。

**ソース:** [`skills/cleanse/SKILL.md`](./skills/cleanse/SKILL.md)
...
### JP Mode — 日本語トランスクリエーション

Webページ、ランディングページ、提案書、マーケティングコピー、UIテキストの日本語を、自然な書き方で生成します。LLMの翻訳でありがちな不自然さを防ぎ、翻訳エンジンではなく日本語コピーライターのように書きます。

以下のトリガーで自動的に起動します: "translate to Japanese"、"Japanese version"、"JP copy"、"localize to Japanese"

**ソース:** [`skills/jp-mode/SKILL.md`](./skills/jp-mode/SKILL.md)
